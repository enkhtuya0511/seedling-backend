...
const AvailableDays = ({ lesson, handlePress }: Props) => {
  return (
          ...
          <div className="grid gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {days.map((item, id) => (
                <Button
                  key={id}
                  variant={lesson?.availableDays?.includes(item) ? "default" : "outline"}
          ...
          <div className="grid gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              {times.map((item, id) => (
                <Button
                  key={id}
                  variant={lesson?.availableTimes?.includes(item) ? "default" : "outline"}
